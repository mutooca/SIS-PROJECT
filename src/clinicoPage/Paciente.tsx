            ...
            rolePaciente === 'dadoUtente' && (
                <div className="border p-4 rounded-md shadow-md space-y-4">
                    ...
                    <div className=" space-y-3 bg-indigo-200  p-4 rounded-md">
                        <h3 className="font-semibold">Informações do Utente (Preenchidas pelo Utente)</h3>
                        <div className='space-y-3 w-full'>
                            <div className="space-y-1 flex flex-col w-full">
                               <h3 className="font-semibold text-blue-800">Histórico Familiar:</h3>
                               <p className="text-blue-800 bg-zinc-50 max-w-full p-1 rounded-md">Pai com diabetes tipo 2, mãe com hipertensão arterial. Avô paterno faleceu de AVC.</p>
                            </div>
                            <div className="space-y-1 flex flex-col w-full">
                               <h3 className="font-semibold text-blue-800">Alergias Conhecidas:</h3>
                               <p className="text-blue-800 bg-zinc-50 max-w-full p-1 rounded-md">Penicilina, Ibuprofeno</p>
                            </div>
                            <div className="space-y-1 flex gap-2 items-center w-full">
                               <h3 className="font-semibold text-blue-800">Cartão de Vacina:</h3>
                               <p className="text-yellow-800 bg-yellow-50 font-semibold p-1 rounded-full">Penicilina, Ibuprofeno</p>
                            </div>
