...
export default function CardLinkEspecialidade({ icon, textbotao,  title, text, textend}: props){
    return(
        <>
            <div className="bg-white shadow rounded-2xl hover:shadow-2xl min-w-[200px] min-h-[250px] p-8 border border-blue-200 flex flex-col items-center justify-center houver:cursor-pointer relative">
                <div className="flex justify-between items-center mb-40 min-w-[325px] absolute top-1 ">
                ...
                <div className="w-full flex flex-col  gap-3 relative  mt-[100px]"> 
