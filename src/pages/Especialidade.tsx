    ...
    return(
         <>
           <div className="  bg-indigo-50  relative mt-15 py-1 ">
               ...
               <div className="flex max-w-full bg-gray-100 h-full items-center justify-center mx-auto">
                <div className="mt-[45px] max-w-7xl mx-auto gap-5 my-14  grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
