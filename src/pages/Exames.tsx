...
export default function Exames(){
    return(
         <>
            <div className="  bg-indigo-50  relative p-4">

                <div className=" flex ml-2 sm:ml-20 flex-col p-4">
                   <h2 className="font-bold text-4xl sm:text-5xl text-zinc-800">Exames Complementares de <span><br />Diagnóstico</span></h2>
                   <p className="flex text-zinc-800 my-4 text-lg">Exames laboratoriais e de imagem com equipamento moderno e resultados precisos</p>
            
                </div>

            <div className="max-w-6xl flex-col  sm:flex-col lg:flex-row mx-auto my-4 ">
                <p className=" text-gray-700 flex rounded-xl p-2 border border-blue-300 bg-blue-100 mx-auto  text-sm gap-1"><p className="font-semibold ">Nota:</p>  Alguns exames requerem prescrição médica. Certifique-se de ter a prescrição registada no seu RCU antes de marcar.</p>
            </div>
