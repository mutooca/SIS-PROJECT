    ...
    return(
         <>
            ...
            <div className="  bg-indigo-50  relative p-6">
                ...
                <button className=" text-gray-700 flex max-w-7xl rounded-xl p-2 min-h-[7px] border border-blue-300 bg-blue-100 mx-auto  text-sm">Nota: Alguns exames requerem prescrição médica. Certifique-se de ter a prescrição registada no seu RCU antes de marcar.</button>
